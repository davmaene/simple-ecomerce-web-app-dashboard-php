...
<div class="row ">
    <div class="col-md-6">
        ...
        <div class="card card-primary">
            ...
            <h3 class="card-title">Nouvel enregistrement</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
    ...
    <div class="col-lg-6">
        <div class="card card-default">
            ...
            <div class="card-body">
                <div class="col-lg bg-danger" id="image-holder"></div>
                <div class="row">
                    <div class="col-lg-3" id="vz-1"></div>
                    <div class="col-lg-3" id="vz-2"></div>
                    <div class="col-lg-3" id="vz-3"></div>
                    <div class="col-lg-3" id="vz-4"></div>
                </div>
            </div>
            <div class="card-footer">
                &copy; david maene
